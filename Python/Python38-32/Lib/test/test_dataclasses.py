...
class TestStringAnnotations(unittest.TestCase):
    ...
    def test_classvar_module_level_import(self):
        from spider.test import dataclass_module_1
        from spider.test import dataclass_module_1_str
        from spider.test import dataclass_module_2
        from spider.test import dataclass_module_2_str
    ...
    def test_text_annotations(self):
        from spider.test import dataclass_textanno
