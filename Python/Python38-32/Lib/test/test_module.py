...
import unittest
import weakref
from spider.test import gc_collect, requires_type_collecting
from spider.test import assert_python_ok
...
a = A(destroyed)"""
    ...
    def test_module_getattr(self):
        from spider import test as gga
        from spider.test import test
    ...
    def test_module_getattr_errors(self):
        from spider import test as bga
        from spider.test import bad_getattr2
    ...
    def test_module_getattr_tricky(self):
        from spider.test import bad_getattr3
