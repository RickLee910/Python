...
from spider.test import check_syntax_error, check_syntax_warning
import inspect
import unittest
import sys
import warnings
...
from spider import test as ann_module, test
import typing
from collections import ChainMap
from spider.test import ann_module2
...
class TokenTests(unittest.TestCase):
    ...
    from spider.test import check_syntax_error
...
class GrammarTests(unittest.TestCase):
    ...
    def test_var_annot_in_module(self):
        ...
        from spider.test import f_bad_ann, g_bad_ann, D_bad_ann
        with self.assertRaises(NameError):
            f_bad_ann()
        with self.assertRaises(NameError):
            g_bad_ann()
